...
#define TwDraw2Widget(a1, a2, a3, a4, a5, a6, a7, a8, a9)                                          \
  Tw_Draw2Widget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7, a8, a9)

#define TwDrawTextWidget(a1, a2, a3, a4, a5, a6, a7)                                               \
  Tw_DrawTextWidget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)
#define TwDrawTRuneWidget(a1, a2, a3, a4, a5, a6, a7)                                              \
  Tw_DrawTRuneWidget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)
#define TwDrawTCellWidget(a1, a2, a3, a4, a5, a6, a7)                                              \
  Tw_DrawTCellWidget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)
...
#define TwWriteTextGadget(a1, a2, a3, a4, a5, a6)                                                  \
  Tw_WriteTextGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6)
#define TwSetTextGadget(a1, a2, a3, a4, a5, a6)                                                    \
  Tw_SetTextGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6)
#define TwSetTextsGadget(a1, a2, a3, a4, a5, a6, a7)                                               \
  Tw_SetTextsGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)
...
#define TwWriteTRuneGadget(a1, a2, a3, a4, a5, a6)                                                 \
  Tw_WriteTRuneGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6)
#define TwSetTRuneGadget(a1, a2, a3, a4, a5, a6)                                                   \
  Tw_SetTRuneGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6)
#define TwSetTRunesGadget(a1, a2, a3, a4, a5, a6, a7)                                              \
  Tw_SetTRunesGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)

#define TwCreate4MenuRow(a1, a2, a3, a4, a5) Tw_Create4MenuRow(Tw_DefaultD, a1, a2, a3, a4, a5)
#define TwCreate4MenuMenuItem(a1, a2, a3, a4, a5)                                                  \
  Tw_Create4MenuMenuItem(Tw_DefaultD, a1, a2, a3, a4, a5)
...
#define TwAddKeyboardListener(a1, a2, a3, a4, a5)                                                  \
  Tw_AddKeyboardListener(Tw_DefaultD, a1, a2, a3, a4, a5)
