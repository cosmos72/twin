...
/** actually draw (part of) the contents of the ttvisible `o' - internally called by
 * TTBuiltinRepaint_ttvisible */
void TTDraw_ttvisible(ttvisible o, ttshort x, ttshort y, ttshort w, ttshort h, ttshort pitch,
