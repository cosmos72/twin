...
uldat Tw_FindFunction(tdisplay TwD, byte namelen, TW_CONST char *name, byte protolen,
                      TW_CONST char *proto);
...
void Tw_DrawWidget(tdisplay TwD, twidget W, dat w, dat h, dat x, dat y, TW_CONST char *text,
                   TW_CONST trune *textfont, TW_CONST tcell *textattr);
...
tgadget Tw_CreateGadget(tdisplay TwD, twidget parent, dat w, dat h, TW_CONST char *text,
                        uldat attrib, uldat flags, udat code, tcolor coltext, tcolor colselect,
                        tcolor coldisabled, tcolor colselectdisabled, dat x, dat y);

tgadget Tw_CreateButtonGadget(tdisplay TwD, twidget parent, dat w, dat h, TW_CONST char *text,
                              uldat flags, udat code, tcolor colbg, tcolor col, tcolor coldisabled,
                              dat x, dat y);

void Tw_WriteTextsGadget(tdisplay TwD, tgadget G, byte mask, dat w, dat h, TW_CONST char *text,
                         dat x, dat y);
void Tw_WriteTRunesGadget(tdisplay TwD, tgadget G, byte mask, dat w, dat h,
                          TW_CONST trune *textfont, dat x, dat y);

twindow Tw_CreateWindow(tdisplay TwD, dat titlelen, TW_CONST char *title, TW_CONST tcolor *coltitle,
...
void Tw_WriteTCellWindow(tdisplay TwD, twindow W, dat x, dat y, uldat len,
                         TW_CONST tcell *textattr);
...
tmenu Tw_CreateMenu(tdisplay TwD, tcolor colitem, tcolor colselect, tcolor coldisabled,
                    ...
                    byte flags);
void Tw_SetInfoMenu(tdisplay TwD, tmenu M, byte flags, ldat len, TW_CONST char *text,
                    TW_CONST tcolor *coltext);
...
void Tw_NotifySelection(tdisplay TwD, tobj requestor, uldat reqprivate, uldat magic,
                        TW_CONST char *mime, uldat len, TW_CONST char *data);
