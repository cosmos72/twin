m4_define([TW_OUTPUT], [[
  echo '#ifndef TWAUTOCONF_H'      >  include/twautoconf.h
  echo '#define TWAUTOCONF_H'      >> include/twautoconf.h
  ...
  echo                              >> include/twautoconf.h
  echo '#endif /* TWAUTOCONF_H */' >> include/twautoconf.h

  $MKDIR_P include/Tw 2>/dev/null

  $SED -e 's/TWAUTOCONF_H/TW_AUTOCONF_H/g' < include/twautoconf.h > include/Tw/autoconf.h
