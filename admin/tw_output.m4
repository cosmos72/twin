m4_define([TW_OUTPUT], [[
  ...
  echo                              >> include/twconfig.h
  echo '#ifndef _TWAUTOCONF_H'      >> include/twconfig.h
  echo '# include "twautoconf.h" /* for TW_HAVE_* macros */'  >> include/twconfig.h
  echo '#endif'                     >> include/twconfig.h
  echo                              >> include/twconfig.h

  tw_cfg CONF__MODULES "$enable__modules"
