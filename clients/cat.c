...
static byte InitCat(void) {
  ...
  return TwCheckMagic(cat_magic) && TwOpen(NULL) && (Cat_MsgPort = TwCreateMsgPort(5, "twcat")) &&
         ...
         (TwInfo4Menu(Cat_Menu, TW_ROW_ACTIVE, 10, " Twin Cat ", (TW_CONST hwcol *)"ptpppptpppppp"),
          (Cat_Win = TwCreateWindow(8, "Twin Cat", NULL, Cat_Menu, COL(BLACK, HIGH | BLACK),
                                    TW_LINECURSOR,
         ...
         (TwSetColorsWindow(Cat_Win, 0x1FF, COL(HIGH | GREEN, WHITE), COL(CYAN, BLUE),
