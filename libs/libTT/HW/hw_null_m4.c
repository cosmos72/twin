...
static void null_Del_ttobj(ttobj o) {
	...
	/* ttobj_refcount_alive flag should already be removed */
	if (!o->refcount) {
	    
	    /* drop Id as late as possible (for listeners) */
	    DropId(o);
	    
	    if (!(o->oflags & ttobj_oflags_static))
		TTFreeMem(o);
	} else {
	    /*
...
static ttevent null_New_ttevent(ttfn_ttevent FN, ttevent o) {
    if ((o = (ttevent)TFN(ttobj)->New((ttfn_ttobj)FN, (ttobj)o))) {
...
/* tteventbig */
static tteventbig null_New_tteventbig(ttfn_tteventbig FN, tteventbig o) {
    if ((o = (tteventbig)TFN(ttevent)->New((ttfn_ttevent)FN, (ttevent)o))) {
...
/* ttbitmask */
static ttbitmask null_New_ttbitmask(ttfn_ttbitmask FN, ttbitmask o) {
    if ((o = (ttbitmask)TFN(ttobj)->New((ttfn_ttobj)FN, (ttobj)o))) {
...
/* tteventmask */
static tteventmask null_New_tteventmask(ttfn_tteventmask FN, tteventmask o) {
    if ((o = (tteventmask)TFN(ttobj)->New((ttfn_ttobj)FN, (ttobj)o))) {
...
static void null_Del_tteventmask(tteventmask o) {
	...
	TFN(ttobj)->Del((ttobj)o);
    }
}

/* ttcallback */
static ttcallback null_New_ttcallback(ttfn_ttcallback FN, ttcallback o) {
    if ((o = (ttcallback)TFN(ttobj)->New((ttfn_ttobj)FN, (ttobj)o))) {
	o->lflags = 0;
	o->component = (ttcomponent)0;
...
static ttlistener null_New_ttlistener(ttfn_ttlistener FN, ttlistener o) {
    if ((o = (ttlistener)TFN(ttcallback)->New((ttfn_ttcallback)FN, (ttcallback)o))) {
	o->AVL = empty_AVL;
...
static void null_Del_ttlistener(ttlistener o) {
	...
	TFN(ttcallback)->Del((ttcallback)o);
    }
}
...
/* tttimer */
static tttimer null_New_tttimer(ttfn_tttimer FN, tttimer o) {
    if ((o = (tttimer)TFN(ttlistener)->New((ttfn_ttlistener)FN, (ttlistener)o))) {
	o->t = (time_t)0;
	o->f = (frac_t)0;
...
static void null_Del_tttimer(tttimer o) {
    if (o) {
	o->FN->Remove(o);
	TFN(ttlistener)->Del((ttlistener)o);
    }
}
...
/* ttdata */
static ttdata null_New_ttdata(ttfn_ttdata FN, ttdata o) {
    if ((o = (ttdata)TFN(ttcomponent)->New((ttfn_ttcomponent)FN, (ttcomponent)o))) {
	o->AVL = empty_AVL;
	o->component = (ttcomponent)0;
	o->key = NULL;
...
static void null_Del_ttdata(ttdata o) {
    if (o) {
	o->FN->Remove(o);
	TFN(ttcomponent)->Del((ttcomponent)o);
    }
}
...
static ttcomponent null_New_ttcomponent(ttfn_ttcomponent FN, ttcomponent o) {
    if ((o = (ttcomponent)TFN(ttobj)->New((ttfn_ttobj)FN, (ttobj)o))) {
...
static ttvisible null_New_ttvisible(ttfn_ttvisible FN, ttvisible o) {
    if ((o = (ttvisible)TFN(ttcomponent)->New((ttfn_ttcomponent)FN, (ttcomponent)o))) {
...
static ttwidget null_New_ttwidget(ttfn_ttwidget FN, ttwidget o) {
    if ((o = (ttwidget)TFN(ttvisible)->New((ttfn_ttvisible)FN, (ttvisible)o))) {
	o->x = o->y = o->xl = o->yl = 0;
	o->w = o->h = o->wl = o->hl = 1;
...
static void null_Del_ttwidget(ttwidget o) {
	...
	TFN(ttvisible)->Del((ttvisible)o);
    }
}
static void null_AddTo_ttwidget(ttwidget o, ttvisible parent) {
    if (parent && !o->parent) {
	/* prepend to list, cannot use TFN(ttvisible)->AddTo() */
...
static void null_SetXY_ttwidget(ttwidget o, ttshort x, ttshort y) {
    o->x = x;
    o->y = y;
}
static void null_SetWH_ttwidget(ttwidget o, ttshort w, ttshort h) {
    o->w = w;
    o->h = h;
}
static void null_SetXl_ttwidget(ttwidget o, ttint xl) {
    o->xl = xl;
}
static void null_SetYl_ttwidget(ttwidget o, ttint yl) {
    o->yl = yl;
}
static void null_SetWl_ttwidget(ttwidget o, ttint wl) {
    o->wl = wl;
}
static void null_SetHl_ttwidget(ttwidget o, ttint hl) {
    o->hl = hl;
}
static void null_SetTooltip_ttwidget(ttwidget o, tttooltip t) {
    if (o->tooltip != t) {
	if (o->tooltip)
	    TDEL(o->tooltip);
	if ((o->tooltip = t))
...
static ttlabel null_New_ttlabel(ttfn_ttlabel FN, ttlabel o) {
    if ((o = (ttlabel)TFN(ttwidget)->New((ttfn_ttwidget)FN, (ttwidget)o))) {
	o->text_len = 0;
	o->text = NULL;
...
static void null_Del_ttlabel(ttlabel o) {
	...
	TFN(ttwidget)->Del((ttwidget)o);
    }
}
static byte null_DoSetFont_ttlabel(ttlabel o, ttfont * text, ttopaque text_len) {
    if (o->text)
	TTFreeMem(o->text);
    o->text = text;
    o->text_len = text_len;
...
/* tttooltip */
static tttooltip null_New_tttooltip(ttfn_tttooltip FN, tttooltip o) {
    if ((o = (tttooltip)TFN(ttlabel)->New((ttfn_ttlabel)FN, (ttlabel)o))) {
	o->widget = (ttwidget)0;
	o->widget_listener = (ttlistener)0;
    }
    return o;
}
static void null_SetWidget_tttooltip(tttooltip o, ttwidget w) {
    if (o->widget != w) {
	if (o->widget_listener)
	    TDEL(o->widget_listener);
#if 0
	if (w && !null_CreateWidgetListener_tttooltip(o, w))
	    return;
#endif
	o->widget = w;
...
static void null_Del_tttooltip(tttooltip o) {
	...
	if (o->widget) {
	    ...
	    TTSetWidget_tttooltip((tt_obj)o->id, NOID);
	}
	TFN(ttlabel)->Del((ttlabel)o);
    }
}


/* ttbuttongroup */
static ttbuttongroup null_New_ttbuttongroup(ttfn_ttbuttongroup FN, ttbuttongroup o) {
    if ((o = (ttbuttongroup)TFN(ttcomponent)->New((ttfn_ttcomponent)FN, (ttcomponent)o))) {
...
static void null_Add_ttbuttongroup(ttbuttongroup g, ttradiobutton o) {
	...
	if (!g->checked && (o->vflags & ttcheckbutton_vflags_checked)) {
	    ...
	    FIRE_EVENT(g->checked = o, g,
		       ttbuttongroup_checked, o, (ttradiobutton)0);
	}
    }
}
static void null_Remove_ttbuttongroup(ttbuttongroup g, ttradiobutton o) {
    if (o && o->group == g) {
	if (o == g->checked)
	    g->FN->SetChecked(g, (ttradiobutton)0);
...
static void null_SetChecked_ttbuttongroup(ttbuttongroup g, ttradiobutton o) {
	 ...
	 */
	FIRE_EVENT(g->checked = o, g,
		   ttbuttongroup_checked, o, c);
	
	if (c)
	    c->FN->SetChecked(c, TT_FALSE);
	if (o)
	    o->FN->SetChecked(o, TT_TRUE);
    }
}
...
static ttanybutton null_New_ttanybutton(ttfn_ttanybutton FN, ttanybutton o) {
    if ((o = (ttanybutton)TFN(ttwidget)->New((ttfn_ttwidget)FN, (ttwidget)o))) {
	o->text = NULL;
...
static byte null_DoSetAttr_ttanybutton(ttanybutton o, ttattr * text, ttshort width, ttshort height, ttshort pitch) {
...
static ttlistener null_CreateListener_ttbutton(ttbutton o, ttuint evcode) {
	...
	((ttcomponent)o, Create_ttevent(ttevent_evtype_mouse, evcode, 0),
	 0, (ttuint)-1, 0, 1,
	 (ttlistener_fn)null_MouseListener_ttbutton, (TT_CONST ttany *)0);
}
static ttbutton null_New_ttbutton(ttfn_ttbutton FN, ttbutton o) {
    if ((o = (ttbutton)TFN(ttanybutton)->New((ttfn_ttanybutton)FN, (ttanybutton)o))) {
...
static ttcheckbutton null_New_ttcheckbutton(ttfn_ttcheckbutton FN, ttcheckbutton o) {
    if ((o = (ttcheckbutton)TFN(ttbutton)->New((ttfn_ttbutton)FN, (ttbutton)o))) {
...
/* ttradiobutton */
static ttradiobutton null_New_ttradiobutton(ttfn_ttradiobutton FN, ttradiobutton o) {
    if ((o = (ttradiobutton)TFN(ttcheckbutton)->New((ttfn_ttcheckbutton)FN, (ttcheckbutton)o))) {
	o->group = (ttbuttongroup)0;
	o->group_prev = o->group_next = (ttradiobutton)0;
    }
    return o;
...
static void null_Del_ttradiobutton(ttradiobutton o) {
	...
	TFN(ttcheckbutton)->Del((ttcheckbutton)o);
    }
}
static void null_SetChecked_ttradiobutton(ttradiobutton o, ttbyte checked) {
    ttbuttongroup g;
    
    TFN(ttcheckbutton)->SetChecked((ttcheckbutton)o, checked);
...
/* ttanyscroll */
static ttanyscroll null_New_ttanyscroll(ttfn_ttanyscroll FN, ttanyscroll o) {
    if ((o = (ttanyscroll)TFN(ttanybutton)->New((ttfn_ttanybutton)FN, (ttanybutton)o))) {
...
static void null_SetOrientation_ttanyscroll(ttanyscroll o, ttbyte orientation) {
    REVALIDATE(o->orientation = orientation);
}
static void null_SetSize_ttanyscroll(ttanyscroll o, ttint size) {
    REVALIDATE(o->FN->Recalculate(o, size, TT_MIN_ttint, TT_MIN_ttint, TT_MIN_ttint));
}
static void null_SetRealSize_ttanyscroll(ttanyscroll o, ttint real_size) {
    REVALIDATE(o->FN->Recalculate(o, TT_MIN_ttint, real_size, TT_MIN_ttint, TT_MIN_ttint));
}
static void null_SetViewSize_ttanyscroll(ttanyscroll o, ttint view_size) {
    REVALIDATE(o->FN->Recalculate(o, TT_MIN_ttint, TT_MIN_ttint, view_size, TT_MIN_ttint));
}
static void null_SetPosition_ttanyscroll(ttanyscroll o, ttint position) {
    REVALIDATE(o->FN->Recalculate(o, TT_MIN_ttint, TT_MIN_ttint, TT_MIN_ttint, position));
}
static void null_SetState_ttanyscroll(ttanyscroll o, ttuint state) {
...
static ttuint null_CacheThemeShape_anyscroll(ttanyscroll o, ttuint statemask,
    ...
    o->FN->Recalculate(o, TT_MIN_ttint, TT_MIN_ttint, TT_MIN_ttint, TT_MIN_ttint);
...
static void null_Del_ttscrollbar(ttscrollbar o) {
	...
	TFN(ttanyscroll)->Del((ttanyscroll)o);
    }
}
...
static void null_Recalculate_ttscrollbar(ttscrollbar o, ttint size, ttint real_size, ttint view_size, ttint position) {
    TFN(ttanyscroll)->Recalculate((ttanyscroll)o, size, real_size, view_size, position);
    if (o->scrollpane)
...
static ttlistener null_CreateMouseListener_ttscrollbar(ttscrollbar o, ttuint evcode) {
	...
	((ttcomponent)o, Create_ttevent(ttevent_evtype_mouse, evcode, 0),
	 0, (ttuint)-1, 0, 1,
	 (ttlistener_fn)null_MouseListener_ttscrollbar, (TT_CONST ttany *)0);
}
...
TT_INLINE tttimer null_CreateTimer_ttscrollbar(ttscrollbar o) {
    return CreateA_tttimer((ttcomponent)o, 0, -1, 0, 2,
			   (ttlistener_fn)null_TimerListener_ttscrollbar,
			   (TT_CONST ttany *)0, 0, 0);
}
static ttscrollbar null_New_ttscrollbar(ttfn_ttscrollbar FN, ttscrollbar o) {
    if ((o = (ttscrollbar)TFN(ttanyscroll)->New((ttfn_ttanyscroll)FN, (ttanyscroll)o))) {
...
static ttlistener null_CreateMouseListener_ttslider(ttslider o, ttuint evcode) {
	...
	((ttcomponent)o, Create_ttevent(ttevent_evtype_mouse, evcode, 0),
	 0, (ttuint)-1, 0, 1,
	 (ttlistener_fn)null_MouseListener_ttslider, (TT_CONST ttany *)0);
}
...
TT_INLINE tttimer null_CreateTimer_ttslider(ttslider o) {
    return CreateA_tttimer((ttcomponent)o, 0, -1, 0, 2,
			   (ttlistener_fn)null_TimerListener_ttslider,
			   (TT_CONST ttany *)0, 0, 0);
}
static ttslider null_New_ttslider(ttfn_ttslider FN, ttslider o) {
    if ((o = (ttslider)TFN(ttanyscroll)->New((ttfn_ttanyscroll)FN, (ttanyscroll)o))) {
...
static void null_Recalculate_ttslider(ttslider o, ttint size, ttint real_size, ttint view_size, ttint position) {
    ...
    TFN(ttanyscroll)->Recalculate((ttanyscroll)o, size, real_size, view_size_, position);
}
...
static void null_SetSize_ttslider(ttslider o, ttint size) {
    /* do-nothing; use SetSlideMin() and SetSlideMax() instead */
}
static void null_SetSlideMin_ttslider(ttslider o, ttint slide_min) {
    REVALIDATE(o->slide_min = slide_min);
}
static void null_SetSlideMax_ttslider(ttslider o, ttint slide_max) {
    REVALIDATE(o->slide_max = slide_max);
}
static void null_SetSlideValue_ttslider(ttslider o, ttint slide_value) {
    ...
    REVALIDATE(
	       ...
	       FIRE_EVENT(
			  o->FN->Recalculate(o, TT_MIN_ttint, TT_MIN_ttint, TT_MIN_ttint, position),
			  o, ttanyscroll_position, position, o->position
			  )
	       );
}
static void null_SetPosition_ttslider(ttslider o, ttint position) {
...
/* ttprogressbar */
static ttprogressbar null_New_ttprogressbar(ttfn_ttprogressbar FN, ttprogressbar o) {
    if ((o = (ttprogressbar)TFN(ttanyscroll)->New((ttfn_ttanyscroll)FN, (ttanyscroll)o))) {
	o->size = 100;
...
/* ttscrollpane */
static ttscrollpane null_New_ttscrollpane(ttfn_ttscrollpane FN, ttscrollpane o) {
    ttscrollbar sx, sy;
    
    if ((o = (ttscrollpane)TFN(ttwidget)->New((ttfn_ttwidget)FN, (ttwidget)o))) {
...
static void null_SetWH_ttscrollpane(ttscrollpane o, ttshort w, ttshort h) {
    ttshort ow = o->w, oh = o->h;
    ttscrollbar sx = o->bar_x, sy = o->bar_y;
    
    
    TFN(ttwidget)->SetWH((ttwidget)o, w, h);
...
static void null_SetXl_ttscrollpane(ttscrollpane o, ttint xl) {
    ttint oxl = o->xl;
    
    TFN(ttwidget)->SetXl((ttwidget)o, xl);
...
static void null_SetYl_ttscrollpane(ttscrollpane o, ttint yl) {
    ttint oyl = o->yl;
    
    TFN(ttwidget)->SetYl((ttwidget)o, yl);
...
static void null_SetWl_ttscrollpane(ttscrollpane o, ttint wl) {
    ttint owl = o->wl;
    
    TFN(ttwidget)->SetWl((ttwidget)o, wl);
...
static void null_SetHl_ttscrollpane(ttscrollpane o, ttint hl) {
    ttint ohl = o->hl;
    
    TFN(ttwidget)->SetHl((ttwidget)o, hl);
...
static void null_AddTo_ttscrollpane(ttscrollpane o, ttvisible parent) {
    ttscrollbar sx, sy;
    
    TFN(ttwidget)->AddTo((ttwidget)o, parent);
    
    if ((sx = o->bar_x))
	TTAdd_ttvisible((tt_obj)parent->id, (tt_obj)sx->id);
    if ((sy = o->bar_y))
	TTAdd_ttvisible((tt_obj)parent->id, (tt_obj)sy->id);
}
static void null_Remove_ttscrollpane(ttscrollpane o) {
    ttscrollbar sx, sy;
    
    TFN(ttwidget)->Remove((ttwidget)o);
...
static void null_SetBarX_ttscrollpane(ttscrollpane o, ttscrollbar b) {
	...
	FIRE_EVENT(o->bar_x = b, o, ttscrollpane_bar_x, b, ob);
	
	if (b) {
	    /* FIXME: we should fire events too */
	    if (b->parent != o->parent) {
		b->FN->Remove(b);
		b->FN->AddTo(b, o->parent);
	    }
	    b->FN->SetXY(b, 0, o->h);
	    b->FN->Recalculate(b, o->wl, TT_MIN_ttint, o->w, o->xl);
	}
    }
}
static void null_SetBarY_ttscrollpane(ttscrollpane o, ttscrollbar b) {
	...
	FIRE_EVENT(o->bar_y = b, o, ttscrollpane_bar_y, b, ob);
	...
	if (b) {
	    ...
	    b->FN->SetXY(b, o->w, 0);
	    b->FN->Recalculate(b, o->hl, TT_MIN_ttint, o->h, o->yl);
	}
    }
}
...
static ttscroller null_New_ttscroller(ttfn_ttscroller FN, ttscroller o) {
    ...
    if ((o = (ttscroller)TFN(ttwindow)->New((ttfn_ttwindow)FN, (ttwindow)o))) {
	if ((o->scrollpane = sp = Create_ttscrollpane(o->w - 1, o->h - 1))) {
	    
	    sp->FN->AddTo(sp, (ttvisible)o);
...
static void null_Del_ttscroller(ttscroller o) {
	...
	TFN(ttwindow)->Del((ttwindow)o);
    }
}
static void null_SetWH_ttscroller(ttscroller o, ttshort w, ttshort h) {
    ttscrollpane sp;
    ttshort ow = o->w, oh = o->h;
    
    TFN(ttwindow)->SetWH((ttwindow)o, w, h);
...
/* ttwindow */
static ttwindow null_New_ttwindow(ttfn_ttwindow FN, ttwindow o) {
    if ((o = (ttwindow)TFN(ttwidget)->New((ttfn_ttwidget)FN, (ttwidget)o))) {
	o->title_len = 0;
	o->title = NULL;
    }
    return o;
...
/* ttframe */
static ttframe null_New_ttframe(ttfn_ttframe FN, ttframe o) {
    if ((o = (ttframe)TFN(ttwindow)->New((ttfn_ttwindow)FN, (ttwindow)o))) {
	o->menubar = NULL;
    }
    return o;
}
...
static void null_SetMenubar_ttframe(ttframe o, ttmenubar m) {
    o->menubar = m;
}
...
static ttmenu null_New_ttmenu(ttfn_ttmenu FN, ttmenu o) {
    if ((o = (ttmenu)TFN(ttmenuitem)->New((ttfn_ttmenuitem)FN, (ttmenuitem)o))) {
...
static ttanytext null_New_ttanytext(ttfn_ttanytext FN, ttanytext o) {
    if ((o = (ttanytext)TFN(ttwindow)->New((ttfn_ttwindow)FN, (ttwindow)o))) {
	o->text = NULL;
	o->text_len = 0;
    }
    return o;
...
static ttapplication null_New_ttapplication(ttfn_ttapplication FN, ttapplication o) {
    if ((o = (ttapplication)TFN(ttcomponent)->New((ttfn_ttcomponent)FN, (ttcomponent)o))) {
	o->name = (ttbyte *)0;
    }
    return o;
}
...
static s_ttfns null_TTFNs = {
  ...
  
  {
    ...
    sizeof(s_ttevent),
    null_New_ttevent,
    (void *)NULL /* inherits:  Build_ttevent -> Build_ttobj */,
    (void *)NULL /* inherits:  Break_ttevent -> Break_ttobj */,
    (void *)NULL /* inherits:  Del_ttevent -> Del_ttobj */,
 ...
 
  {
    ...
    sizeof(s_tteventbig),
    null_New_tteventbig,
    (void *)NULL /* inherits:  Build_tteventbig -> Build_ttobj */,
    (void *)NULL /* inherits:  Break_tteventbig -> Break_ttobj */,
    (void *)NULL /* inherits:  Del_tteventbig -> Del_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttbitmask),
    null_New_ttbitmask,
    (void *)NULL /* inherits:  Build_ttbitmask -> Build_ttobj */,
    (void *)NULL /* inherits:  Break_ttbitmask -> Break_ttobj */,
    (void *)NULL /* inherits:  Del_ttbitmask -> Del_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_tteventmask -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttcallback),
    null_New_ttcallback,
    (void *)NULL /* inherits:  Build_ttcallback -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttlistener),
    null_New_ttlistener,
    (void *)NULL /* inherits:  Build_ttlistener -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttcomponent -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttdata),
    null_New_ttdata,
    (void *)NULL /* inherits:  Build_ttdata -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttvisible),
    null_New_ttvisible,
    (void *)NULL /* inherits:  Build_ttvisible -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttnative -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttwidget),
    null_New_ttwidget,
    (void *)NULL /* inherits:  Build_ttwidget -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttlabel),
    null_New_ttlabel,
    (void *)NULL /* inherits:  Build_ttlabel -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_tttooltip),
    null_New_tttooltip,
    (void *)NULL /* inherits:  Build_tttooltip -> Build_ttobj */,
    ...
    /* extends ttfn_ttwidget */
    (void *)NULL /* inherits:  DoSetFont_tttooltip -> DoSetFont_ttlabel */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttbuttongroup -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttanybutton -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttbutton),
    null_New_ttbutton,
    (void *)NULL /* inherits:  Build_ttbutton -> Build_ttobj */,
    ...
    (void *)NULL /* inherits:  DoSetAttr_ttbutton -> DoSetAttr_ttanybutton */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttcheckbutton -> Build_ttobj */,
    ...
    (void *)NULL /* inherits:  DoSetAttr_ttcheckbutton -> DoSetAttr_ttanybutton */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttradiobutton -> Build_ttobj */,
    ...
    (void *)NULL /* inherits:  DoSetAttr_ttradiobutton -> DoSetAttr_ttanybutton */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttanyscroll -> Build_ttobj */,
    ...
    (void *)NULL /* inherits:  DoSetAttr_ttanyscroll -> DoSetAttr_ttanybutton */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttscrollbar -> Build_ttobj */,
    ...
    (void *)NULL /* inherits:  DoSetAttr_ttscrollbar -> DoSetAttr_ttanybutton */,
 ...
 
  {
    ...
    sizeof(s_ttslider),
    null_New_ttslider,
    (void *)NULL /* inherits:  Build_ttslider -> Build_ttobj */,
    ...
    (void *)NULL /* inherits:  DoSetAttr_ttslider -> DoSetAttr_ttanybutton */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttprogressbar -> Build_ttobj */,
    ...
    (void *)NULL /* inherits:  DoSetAttr_ttprogressbar -> DoSetAttr_ttanybutton */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttscrollpane -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttwindow),
    null_New_ttwindow,
    (void *)NULL /* inherits:  Build_ttwindow -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttscroller),
    null_New_ttscroller,
    (void *)NULL /* inherits:  Build_ttscroller -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttmenuitem -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttcheckmenuitem -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttradiomenuitem -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttmenu),
    null_New_ttmenu,
    (void *)NULL /* inherits:  Build_ttmenu -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttmenubar -> Build_ttobj */,
 ...
 
  {
    ...
    sizeof(s_ttanytext),
    null_New_ttanytext,
    (void *)NULL /* inherits:  Build_ttanytext -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_tttextfield -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_tttextarea -> Build_ttobj */,
 ...
 
  {
    ...
    (void *)NULL /* inherits:  Build_ttapplication -> Build_ttobj */,
