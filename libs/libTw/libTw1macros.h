...
{ Tw_SetXYWidget, 0, 0, "Tw_SetXYWidget", "2""v"TWS_void_STR"x"magic_id_STR(widget)"_"TWS_dat_STR"_"TWS_dat_STR },
{ Tw_GetOwnerWidget, 0, 0, "Tw_GetOwnerWidget", "0""x"magic_id_STR(msgport)"x"magic_id_STR(widget) },
{ Tw_ExposeWidget, 0, 0, "Tw_ExposeWidget", "2""v"TWS_void_STR"x"magic_id_STR(widget)"_"TWS_dat_STR"_"TWS_dat_STR"_"TWS_dat_STR"_"TWS_dat_STR"W"TWS_byte_STR"W"TWS_hwfont_STR"W"TWS_hwattr_STR },
...
{ Tw_Create4MenuRow, 0, 0, "Tw_Create4MenuRow", "1""v"TWS_void_STR"x"magic_id_STR(window)"_"TWS_udat_STR"_"TWS_byte_STR"_"TWS_ldat_STR"V"TWS_byte_STR },
...
{ Tw_Create4MenuMenuItem, 0, 0, "Tw_Create4MenuMenuItem", "1""x"magic_id_STR(menuitem)"x"magic_id_STR(menu)"x"magic_id_STR(window)"_"TWS_byte_STR"_"TWS_dat_STR"V"TWS_byte_STR },
