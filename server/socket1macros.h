...
case order_SetXYWidget:
    Act(SetXY,(widget)a[1].x)((widget)a[1].x, (dat)a[2]._, (dat)a[3]._);
    break;
...
case order_ExposeWidget:
    Act(Expose,(widget)a[1].x)((widget)a[1].x, (dat)a[2]._, (dat)a[3]._, (dat)a[4]._, (dat)a[5]._, (byte CONST *)a[6].V, (hwfont CONST *)a[7].V, (hwattr CONST *)a[8].V);
    break;
...
case order_Create4MenuRow:
    Do(Create4Menu,Row)(FnRow, (window)a[1].x, (udat)a[2]._, (byte)a[3]._, (ldat)a[4]._, (byte CONST *)a[5].V);
    break;
...
case order_Create4MenuMenuItem:
    a[0].x = (obj)Do(Create4Menu,MenuItem)(FnMenuItem, (menu)a[1].x, (window)a[2].x, (byte)a[3]._, (dat)a[4]._, (byte CONST *)a[5].V);
    break;
