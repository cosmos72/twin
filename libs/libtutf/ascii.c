...
const trune T_CAT3(Tutf_, T_MAP(ASCII), _to_UTF_32)[0x100] = {
#define EL(x) T_UTF(UTF_32, x),
    T_LIST(ASCII, EL)
#undef EL
};

const trune T_CAT(Tutf_CP437_to_, T_MAP(ASCII))[0x100] = {
    ' ', 'O', 'O', 'v',  '@', 'g', '!', '.',  '.', 'o', 'o', 't', 'g', 'f', 'f', '*', '>', '<', '|',
    '!', 'q', 'S', '_',  '|', '^', 'v', '>',  '<', 'L', '-', '^', 'v',
    ...
    'A', 'C', 'u', 'e',  'a', 'a', 'a', 'a',  'c', 'e', 'e', 'e', 'i', 'i', 'i', 'A', 'A', 'E', 'E',
    'e', 'o', 'o', 'o',  'u', 'u', 'y', 'O',  'U', 'c', 'L', 'Y', 'P', 'f', 'a', 'o', 'u', 'n', 'N',
    'a', 'o', '?', '-',  '-', '%', '%', '!',  '<', '>', '.', '*', '@', '|', '+', '+', '+', '+', '+',
    '+', '|', '+', '+',  '+', '+', '+', '+',  '+', '+', '+', '-', '+', '+', '+', '+', '+', '+', '+',
    '+', '=', '+', '+',  '+', '+', '+', '+',  '+', '+', '+', '+', '+', '+', '+', '#', '_', '[', ']',
