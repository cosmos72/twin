...
TT_INLINE ttbyte Add_ttvector(ttvector o, ttopaque pos, ttany value) {
  return TTAssert(o && IS(ttvector, o)) && pos <= o->array_n && o->Class->AddY(o, pos, 1, &value);
}
TT_INLINE ttbyte Append_ttvector(ttvector o, ttany value) {
  return TTAssert(o && IS(ttvector, o)) && o->Class->AddY(o, o->array_n, 1, &value);
}
TT_INLINE ttbyte AddA_ttvector(ttvector o, ttopaque pos, ttopaque value_n,
...
TT_INLINE ttbyte RemoveAt_ttvector(ttvector o, ttopaque pos) {
  return TTAssert(o && IS(ttvector, o)) && o->Class->RemoveRange(o, pos, 1);
}
...
static ttbyte Combine_ttbitmask(ttbitmask o, ttany value, ttuint truth_table) {
  ttbitmask o2;
  ttbyte ret = TT_FALSE;
  if (TTAssert(o && IS(ttbitmask, o)) && (o2 = Create_ttbitmask(value))) {
...
TT_INLINE void AddTo_ttvisible(ttvisible o, ttvisible parent, ttany constraints) {
  if (TTAssert(o && IS(ttvisible, o)) && parent && TTAssert(IS(ttvisible, parent)) && !o->parent) {
...
static ttbyte SetXY_ttwidget(ttwidget o, ttshort x, ttshort y) {
  ...
  if (CAN_SET(o, ttwidget)) {
    ...
    if (fx)
      FIRE_EVENT((void)0, o, ttwidget_x, x, ox);
    if (fy)
      FIRE_EVENT((void)0, o, ttwidget_y, y, oy);
  }
  return ret;
}
static ttbyte SetWH_ttwidget(ttwidget o, ttshort w, ttshort h) {
  ...
  if (CAN_SET(o, ttwidget)) {
    ...
    if (fw)
      FIRE_EVENT((void)0, o, ttwidget_w, w, ow);
    if (fh)
      FIRE_EVENT((void)0, o, ttwidget_h, h, oh);
  }
  return ret;
}
TT_INLINE ttbyte SetXYWH_ttwidget(ttwidget o, ttuint mask, ttshort x, ttshort y, ttshort w,
                                  ttshort h) {
  ttbyte ret = TT_TRUE;
  if (ret && (mask & 0x3))
...
TT_INLINE ttbyte SetX_ttwidget(ttwidget o, ttshort x) { return SetXY_ttwidget(o, x, o->y); }
TT_INLINE ttbyte SetY_ttwidget(ttwidget o, ttshort y) { return SetXY_ttwidget(o, o->x, y); }
TT_INLINE ttbyte SetW_ttwidget(ttwidget o, ttshort w) { return SetWH_ttwidget(o, w, o->h); }
TT_INLINE ttbyte SetH_ttwidget(ttwidget o, ttshort h) { return SetWH_ttwidget(o, o->w, h); }
...
/* ttlabel */
static ttbyte SetFontD_ttlabel(ttlabel o, ttopaque text_len,
...
TT_INLINE void Add_ttbuttongroup(ttbuttongroup g, ttradiobutton o) {
  if (CAN_SET(g, ttbuttongroup) && o && TTAssert(IS(ttradiobutton, o)) && !o->group) {
...
TT_INLINE void Remove_ttbuttongroup(ttbuttongroup g, ttradiobutton o) {
  if (TTAssert(g && IS(ttbuttongroup, g)) && o && TTAssert(IS(ttradiobutton, o)) && o->group == g) {
...
TT_INLINE void SetChecked_ttbuttongroup(ttbuttongroup g, ttradiobutton o) {
  if (TTAssert(g && IS(ttbuttongroup, g)) &&
      (!o || (TTAssert(IS(ttradiobutton, o)) && o->group == g)) && o != g->checked) {
...
/* ttanybutton */
static void SetAttrD_ttanybutton(ttanybutton o, ttshort width, ttshort height, ttshort pitch,
                                 TT_ARG_DIE TT_ARG_ARRAY((_P(3), *, _P(4))) ttattr *text) {
  tteventbig e;

  if ((e = Create4_tteventbig(ttevent_evtype_change, ttanybutton_text, 0, pitch, 0, width,
                              height))) {
    e->value = (opaque)text;
...
TT_INLINE ttbyte SetAttr_ttanybutton(ttanybutton o, ttshort width, ttshort height, ttshort pitch,
...
TT_INLINE ttbyte SetFont_ttanybutton(ttanybutton o, ttshort width, ttshort height, ttshort pitch,
...
TT_INLINE ttbyte SetText_ttanybutton(ttanybutton o, ttshort width, ttshort height, ttshort pitch,
...
TT_INLINE ttbyte SetOrientation_ttanyscroll(ttanyscroll o, ttbyte orientation) {
  ...
  if (CAN_SET(o, ttanyscroll)) {
    if (orientation != o->orientation) {
      FIRE_EVENT(ret = o->Class->SetOrientation(o, orientation), o, ttanyscroll_orientation,
...
TT_INLINE ttbyte SetSize_ttanyscroll(ttanyscroll o, ttint size) {
  ...
  if (CAN_SET(o, ttanyscroll)) {
    if ((size = minBOUND(size, 0)) != o->size) {
      FIRE_EVENT(ret = o->Class->SetSize(o, size), o, ttanyscroll_size, size, o->size);
    } else
      ret = TT_TRUE;
  }
  return ret;
...
TT_INLINE ttbyte SetRealSize_ttanyscroll(ttanyscroll o, ttint real_size) {
  ...
  if (CAN_SET(o, ttanyscroll)) {
    if ((real_size = minBOUND(real_size, 0)) != o->real_size) {
      FIRE_EVENT(ret = o->Class->SetRealSize(o, real_size), o, ttanyscroll_real_size, real_size,
                 o->real_size);
    } else
      ret = TT_TRUE;
  }
...
TT_INLINE ttbyte SetViewSize_ttanyscroll(ttanyscroll o, ttint view_size) {
  ...
  if (CAN_SET(o, ttanyscroll)) {
    if ((view_size = BOUND(view_size, 0, o->size)) != o->view_size) {
      FIRE_EVENT(ret = o->Class->SetViewSize(o, view_size), o, ttanyscroll_view_size, view_size,
                 o->view_size);
    } else
      ret = TT_TRUE;
  }
...
TT_INLINE ttbyte SetPosition_ttanyscroll(ttanyscroll o, ttint position) {
  ...
  if (CAN_SET(o, ttanyscroll)) {
    if ((position = BOUND(position, 0, o->size - o->view_size)) != o->position) {
      FIRE_EVENT(ret = o->Class->SetPosition(o, position), o, ttanyscroll_position, position,
                 o->position);
    } else
      ret = TT_TRUE;
  }
...
TT_INLINE ttbyte SetSlideMin_ttslider(ttslider o, ttint slide_min) {
  ...
  if (CAN_SET(o, ttslider)) {
    if (slide_min != o->slide_min) {
      FIRE_EVENT(ret = o->Class->SetSlideMin(o, slide_min), o, ttslider_slide_min, slide_min,
                 o->slide_min);
    } else
      ret = TT_TRUE;
  }
...
TT_INLINE ttbyte SetSlideMax_ttslider(ttslider o, ttint slide_max) {
  ...
  if (CAN_SET(o, ttslider)) {
    if (slide_max != o->slide_max) {
      FIRE_EVENT(ret = o->Class->SetSlideMax(o, slide_max), o, ttslider_slide_max, slide_max,
                 o->slide_max);
    } else
      ret = TT_TRUE;
  }
...
TT_INLINE ttbyte SetSlideValue_ttslider(ttslider o, ttint slide_value) {
  ...
  if (CAN_SET(o, ttslider)) {
    if ((slide_value = BOUND(slide_value, o->slide_min, o->slide_max)) != o->slide_value) {
      FIRE_EVENT(ret = o->Class->SetSlideValue(o, slide_value), o, ttslider_slide_value,
                 slide_value, o->slide_value);
    } else
      ret = TT_TRUE;
  }
  return ret;
...
TT_INLINE ttbyte SetTitle_ttwindow(ttwindow o, TT_ARG_READ ttbyte *title) {
  ...
  if (CAN_SET(o, ttwindow))
    FIRE_EVENT(ret = o->Class->SetTitle(o, title), o, ttwindow_title, (opaque)title,
               (opaque)o->title);
  return ret;
}
...
TT_INLINE ttbyte SetMenubar_ttframe(ttframe o, ttmenubar m) {
  ...
  if (CAN_SET(o, ttframe) && (!m || TTAssert(IS(ttmenubar, m)))) {
    if (m != o->menubar) {
      FIRE_EVENT_O(ret = o->Class->SetMenubar(o, m), o, ttframe_menubar, m, o->menubar);
    } else
      ret = TT_TRUE;
  }
  return ret;
