...
static ttcallback gtk_AddAskCloseCallback_ttframe(ttframe o) {
  ...
  if ((l = Create_ttcallback((ttcomponent)o))) {
    if ((l->native = (opaque)gtk_signal_connect(GTK_OBJECT((gpointer)o->native), "delete_event",
                                                GTK_SIGNAL_FUNC(gtk_AskCloseCallback_ttframe),
                                                (gpointer)id)))
      return l;
    TDEL(l);
  }
...
static ttbyte gtk_Sync(void) { return 1; }
static ttbyte gtk_Flush(void) { return 1; }
static ttbyte gtk_TimidFlush(void) { return 1; }
#if 0 /* not used */
...
static int gtk_ConnectionFd(void) { return -1; }
static ttuint gtk_GetErrno(void) { return TT_GTK_EUNFINISHED; }
static ttuint gtk_GetErrnoDetail(void) { return 0; }
...
static TT_CONST ttbyte *gtk_StrErrorDetail(ttuint E, ttuint S) { return ""; }
...
static s_ttclasses gtk_TTClasses = {
...

    {
        ...
        /* extends ttclass_ttcomponent */
        (void *)NULL /* UNDEFINED: AddTo_ttmenu */, (void *)NULL /* UNDEFINED: Validate_ttmenu */,
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_ttmenubar */, (void *)NULL /* UNDEFINED: Build_ttmenubar */,
