...
#define TwCreateWidget(a1, a2, a3, a4, a5, a6, a7)                                                 \
  Tw_CreateWidget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)
...
#define TwDrawWidget(a1, a2, a3, a4, a5, a6, a7, a8)                                               \
  Tw_DrawWidget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7, a8)
...
#define TwCreateGadget(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13)                     \
  Tw_CreateGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13)

#define TwCreateButtonGadget(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11)                         \
  Tw_CreateButtonGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11)

#define TwWriteTextsGadget(a1, a2, a3, a4, a5, a6, a7)                                             \
  Tw_WriteTextsGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)
#define TwWriteTRunesGadget(a1, a2, a3, a4, a5, a6, a7)                                            \
  Tw_WriteTRunesGadget(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)

#define TwCreateWindow(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11)                               \
  Tw_CreateWindow(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11)
...
#define TwSetColorsWindow(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11)                            \
  Tw_SetColorsWindow(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11)
#define TwConfigureWindow(a1, a2, a3, a4, a5, a6, a7, a8)                                          \
  Tw_ConfigureWindow(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7, a8)
...
#define TwCreate4MenuAny(a1, a2, a3, a4, a5, a6)                                                   \
  Tw_Create4MenuAny(Tw_DefaultD, a1, a2, a3, a4, a5, a6)

#define TwCreate4MenuCommonMenuItem(a1) Tw_Create4MenuCommonMenuItem(Tw_DefaultD, a1)

#define TwCreateMenu(a1, a2, a3, a4, a5, a6, a7)                                                   \
  Tw_CreateMenu(Tw_DefaultD, a1, a2, a3, a4, a5, a6, a7)
...
#define TwNotifySelection(a1, a2, a3, a4, a5, a6)                                                  \
  Tw_NotifySelection(Tw_DefaultD, a1, a2, a3, a4, a5, a6)
