...
download "adobe_stdenc.txt" http://unicode.org/Public/MAPPINGS/ADOBE/stdenc.txt
download "adobe_symbol.txt" http://unicode.org/Public/MAPPINGS/ADOBE/symbol.txt

for N in ARABIC.TXT CELTIC.TXT CENTEURO.TXT CHINSIMP.TXT CHINTRAD.TXT \
         CROATIAN.TXT CYRILLIC.TXT DEVANAGA.TXT DINGBATS.TXT FARSI.TXT GAELIC.TXT \
         GREEK.TXT GUJARATI.TXT GURMUKHI.TXT HEBREW.TXT ICELAND.TXT INUIT.TXT \
         JAPANESE.TXT KOREAN.TXT ROMAN.TXT ROMANIAN.TXT SYMBOL.TXT THAI.TXT \
         TURKISH.TXT # CORPCHAR.TXT UKRAINE.TXT
do
  n="apple_`echo $N | tr 'A-Z' 'a-z'`"
...
for N in CP737.TXT CP775.TXT CP852.TXT CP855.TXT CP857.TXT CP860.TXT CP861.TXT \
         CP862.TXT CP863.TXT CP864.TXT CP865.TXT CP866.TXT CP869.TXT CP874.TXT # CP437.TXT CP850.TXT 
do
  n="`echo $N | tr 'A-Z' 'a-z'`"
