...
ttlistener TTCreate_ttlistener(ttcomponent o, ttuint evtype, ttuint lflags,
                               TT_ARG_READ ttlistener_fn function, ttany arg);

/** create a ttlistener for a ttcomponent with given fields */
ttlistener TTCreateE_ttlistener(ttcomponent o, TT_ARG_DIE ttevent ev, ttuint lflags,
                                TT_ARG_READ ttlistener_fn function, ttany arg);

/** create a ttlistener for a ttcomponent with given fields */
ttlistener TTCreateR_ttlistener(ttcomponent o, TT_ARG_DIE ttevent ev, ttuint lflags,
...
ttlistener TTCreateAskclose_ttlistener(ttcomponent o, ttuint lflags,
                                       TT_ARG_READ ttlistener_fn function);

/** create a ttlistener for a ttcomponent "key" ttevent with given fields */
ttlistener TTCreateKey_ttlistener(ttcomponent o, ttuint evcode, ttuint evflags, ttuint lflags,
                                  TT_ARG_READ ttlistener_fn function);

/** create a ttlistener for a ttcomponent "mouse" ttevent with given fields */
ttlistener TTCreateMouse_ttlistener(ttcomponent o, ttuint evcode, ttuint evflags, ttuint lflags,
                                    TT_ARG_READ ttlistener_fn function);

/** create a ttlistener for a ttcomponent "activate" ttevent with given fields */
ttlistener TTCreateActivate_ttlistener(ttcomponent o, ttuint lflags,
                                       TT_ARG_READ ttlistener_fn function);

/** create a ttlistener for a ttcomponent "value change" ttevent with given fields */
ttlistener TTCreateChange_ttlistener(ttcomponent o, ttuint evcode, ttuint lflags,
                                     TT_ARG_READ ttlistener_fn function);

/** create a ttlistener for a ttcomponent "key_data value change" ttevent with given fields
 * (WARNING: listener will be called with `ttdata' as event component!)*/
ttlistener TTCreateKeyData_ttlistener(ttcomponent o, TT_ARG_READ TT_ARG_ARRAY_Z ttbyte *key,
                                      ttuint lflags, TT_ARG_READ ttlistener_fn function);

/** create a ttlistener for a ttcomponent "expose" ttevent with given fields */
ttlistener TTCreateExpose_ttlistener(ttcomponent o, ttuint lflags,
                                     TT_ARG_READ ttlistener_fn function);
