...
PROTO(void,v,      SetXY,Widget,2, widget,x, dat,_, dat,_)
PROTO(msgport,x,GetOwner,Widget,0, widget,x)
PROTO(void,v,     Expose,Widget,2, widget,x, dat,_, dat,_, dat,_, dat,_, byte,W(A(2)*A(3)), hwfont,W(A(2)*A(3)), hwattr,W(A(2)*A(3)))
...
PROTO(void,v,   Create4Menu,Row,1, window,x, udat,_, byte,_, ldat,_, byte,V(A(4)))
...
PROTO(menuitem,x,    Create4Menu,MenuItem,1, menu,x, window,x, byte,_, dat,_, byte,V(A(4)))
