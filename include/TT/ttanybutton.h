...
void TTSetAttrD_ttanybutton(ttanybutton o, ttshort w, ttshort h, ttshort pitch,
                            TT_ARG_DIE TT_ARG_ARRAY((_P(3), *, _P(4))) ttattr *text);

/** set the text of the ttanybutton `o' to a copy of `text' */
ttbyte TTSetAttr_ttanybutton(ttanybutton o, ttshort w, ttshort h, ttshort pitch,
                             TT_ARG_READ TT_ARG_ARRAY((_P(3), *, _P(4))) ttattr *text);

/** set the text of the ttanybutton `o' to a copy of `text' */
ttbyte TTSetFont_ttanybutton(ttanybutton o, ttshort w, ttshort h, ttshort pitch,
                             TT_ARG_READ TT_ARG_ARRAY((_P(3), *, _P(4))) ttfont *text);

/** set the text of the ttanybutton `o' to a copy of `text' */
ttbyte TTSetText_ttanybutton(ttanybutton o, ttshort w, ttshort h, ttshort pitch,
                             TT_ARG_READ TT_ARG_ARRAY((_P(3), *, _P(4))) ttbyte *text);

/** create a ttanybutton with a copy of given text */
ttanybutton TTCreate_ttanybutton(ttshort w, ttshort h, ttshort pitch,
