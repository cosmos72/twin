...
extern struct s_ttfn_tttheme s_TTFN_tttheme;
...
static hwattr t_normalbutton[] = {
    t(' '), 0,
    0, 0
};

static hwattr s_normalbutton[] = {
...
static hwattr t_prelightbutton[] = {
    t(' '), 0,
    0, 0
};
static hwattr s_prelightbutton[] = {
    0, s(T_UTF_16_LOWER_HALF_BLOCK),
    0, s(T_UTF_16_FULL_BLOCK),
    s(' '), s(T_UTF_16_UPPER_HALF_BLOCK)
};
...
static hwattr t_pressedbutton[] = {
    0, t(' '),
    0, 0
};
static hwattr s_pressedbutton[] = {
    s(' '), 0,
    s(' '), s(' ')
};
...
static hwattr t_disabledbutton[] = {
    t(' '), 0,
    0, 0
};
static hwattr s_disabledbutton[] = {
    0, s(' '),
    s(' '), s(' ')
};


static struct s_tttheme s_DummyTheme = {
    &s_TTFN_tttheme,
    TW_NOID,
    NULL,
    { },
