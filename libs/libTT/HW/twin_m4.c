...
static ttcallback twin_AddCommonCallbacks_ttwidget(ttwidget o) {
  ...
  if ((l[i] = Create_ttcallback((ttcomponent)o)) &&
      (l[i]->native = (opaque)TwAddWidgetListener(
           o->native, TW_MSG_WIDGET_EXPOSE, (tfn_listener)twin_ExposeCallback_ttwidget, id)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native = (opaque)TwAddWidgetListener(
           o->native, TW_MSG_WIDGET_RESIZE, (tfn_listener)twin_ResizeCallback_ttwidget, id))) {
...
static void twin_Draw_ttwidget(ttwidget o, ttshort x, ttshort y, ttshort w, ttshort h,
                               ttshort pitch, TT_CONST ttbyte *asciidata, TT_CONST ttfont *fontdata,
                               TT_CONST ttattr *attrdata) {
...
static ttcallback twin_AddCommonCallbacks_ttanybutton(ttanybutton o) {
  ...
  if ((l[i] = twin_AddCommonCallbacks_ttwidget((ttwidget)o)) &&
      ...
      (l[i]->native = (opaque)TwAddMouseListener(
           o->native, MOVE_MOUSE, 0, (tfn_listener)twin_MouseCallback_ttanybutton, id)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native = (opaque)TwAddMouseListener(
           o->native, PRESS_LEFT, 0, (tfn_listener)twin_MouseCallback_ttanybutton, id)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native =
           (opaque)TwAddMouseListener(o->native, MOVE_MOUSE | HOLD_LEFT, 0,
                                      (tfn_listener)twin_MouseCallback_ttanybutton, id)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native = (opaque)TwAddMouseListener(
           o->native, RELEASE_LEFT, 0, (tfn_listener)twin_MouseCallback_ttanybutton, id))) {
...
static ttwindow twin_Build_ttwindow(ttwindow o) {
  if (TW_NOID !=
      (o->native = TwCreateWindow(
           o->title ? TTLenStr(o->title) : 0, o->title, NULL, TW_NOID, o->col, TW_LINECURSOR,
           TW_WINDOW_DRAG | TW_WINDOW_WANT_CHANGES | TW_WINDOW_WANT_KEYS | TW_WINDOW_WANT_MOUSE |
               TW_WINDOW_WANT_MOUSE_MOTION | TW_WIDGET_AUTO_FOCUS,
           TW_WINDOWFL_USEEXPOSE | TW_WINDOWFL_CURSOR_ON | TW_WINDOWFL_BORDERLESS, o->w, o->h,
           0))) {
    if (twin_AddCommonCallbacks_ttwidget((ttwidget)o)) {
      twin_AtBuild_ttvisible((ttvisible)o);
      return o;
...
static ttframe twin_Build_ttframe(ttframe o) {
  ...
  if (TW_NOID != (o->native = TwCreateWindow(
                      o->title ? TTLenStr(o->title) : 0, o->title, NULL, myMenubar_n(o), o->col,
                      TW_LINECURSOR,
      ...
      twin_AddCommonCallbacks_ttwidget((ttwidget)o) && twin_AddAskCloseCallback_ttframe(o)) {
...
static void twin_AddTo_ttmenuitem(ttmenuitem o, ttvisible parent, ttany constraint) {
  ...
  if (parent && !o->parent && TTAssert(IS(ttmenu, parent)) &&
    ...
    if (!(udat)Code)
      Code = 1 + (rand() & 0xFFF);
    o->native = TwRow4Menu(parent->target_private, Code,
                           *o->name ? (o->vflags & ttanybutton_vflags_disabled) ? TW_ROW_ACTIVE
                                                                                : TW_ROW_INACTIVE
                                    : TW_ROW_IGNORE,
...
static s_ttclasses twin_TTClasses = {
...

    {
        ...
        twin_Remove_ttmenuitem, (void *)NULL /* UNDEFINED: Invalidate_ttmenuitem */,
...

    {
        ...
        /* extends ttclass_ttcomponent */
        twin_AddTo_ttmenu, (void *)NULL /* UNDEFINED: Validate_ttmenu */, twin_Remove_ttmenu,
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_ttmenubar */, twin_Build_ttmenubar,
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_ttapplication */, twin_Build_ttapplication,
