...
ttbyte TTAddA_ttvector(ttvector o, ttopaque pos, ttopaque value_n,
...
/** add values at given position of ttvector `o' */
ttbyte TTAddV_ttvector(ttvector o, ttopaque pos, ttopaque value_n,
                       TT_ARG_ARRAY((1)) va_list *values);

/** add values at given position of ttvector `o' */
ttbyte TTAddY_ttvector(ttvector o, ttopaque pos, ttopaque value_n,
