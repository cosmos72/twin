m4_define([TW_OUTPUT], [[
  ...
  echo '#ifndef TW_AUTOCONF_H'      >  include/Tw/autoconf.h
  echo '#define TW_AUTOCONF_H'      >> include/Tw/autoconf.h
  echo                              >> include/Tw/autoconf.h
  echo '/* this file is autogenerated by GNU configure, any change will be LOST when configure is re-executed */' >> include/Tw/autoconf.h
  echo                              >> include/Tw/autoconf.h
  ...
  $SED -e 's/define *\([A-Z]\)/define TW_\1/g' \
       ...
       -e 's/ifndef *\([A-Z]\)/ifndef TW_\1/g' \
                 < include/config.h >> include/Tw/autoconf.h
  echo                              >> include/Tw/autoconf.h

  echo                              >> include/Tw/autoconf.h
  echo '#endif /* TW_AUTOCONF_H */' >> include/Tw/autoconf.h

  echo '#ifndef TWCONFIG_H'         >  include/twconfig.h
  echo '#define TWCONFIG_H'         >> include/twconfig.h
  ...
  tw_cfg CONF_SERVER_STATIC     "$enable_server_static"
  ...
  tw_cfg CONF_RCPARSE           "$enable_rcparse"
  tw_cfg CONF_RCPARSE_SHMMAP    "$enable_rcparse_shmmap"
  tw_cfg CONF_RCPARSE_SHRINK    "$enable_rcparse_shrink"
  ...
  echo                              >> include/twconfig.h
  echo '#endif /* TWCONFIG_H */'    >> include/twconfig.h
