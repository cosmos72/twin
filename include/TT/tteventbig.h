...
tteventbig TTCreate8_tteventbig(ttuint evtype, ttuint evcode, ttuint evflags, ttshort x, ttshort y,
                                ttshort w, ttshort h, ttany value, ttany old_value,
                                ttopaque data_len, TT_ARG_READ TT_ARG_ARRAY((_P(10))) ttbyte *data);

/** create a tteventbig with given fields */
tteventbig TTCreate4_tteventbig(ttuint evtype, ttuint evcode, ttuint evflags, ttshort x, ttshort,
                                ttshort w, ttshort h);

/** create a tteventbig with given fields */
tteventbig TTCreate4s4_tteventbig(ttuint evtype, ttuint evcode, ttuint evflags, ttany value,
