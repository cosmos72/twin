...
/* This file was automatically generated from twin_detunnel_c by m4/hw.m4h, do not edit! */

/*
 *  twin_detunnel_m4.c  --  implementation of libTT methods on "twin_detunnel" target display
 *
...
static tlistener twin_detunnel_TwAddGadgetListener(twidget W, udat Code, tfn_listener Listener,
                                                   void *Arg) {
  return (tlistener)0;
}
static tlistener twin_detunnel_TwAddWidgetListener(twidget W, udat Code, tfn_listener Listener,
                                                   void *Arg) {
  return (tlistener)0;
}
static tmenuitem twin_detunnel_TwCreate4MenuRow(twindow Window, udat Code, byte Flags, ldat Len,
                                                TW_CONST byte *Text) {
  return (tmenuitem)0;
}
static tmenuitem twin_detunnel_TwCreate4MenuMenuItem(tobj Parent, twindow Window, byte Flags,
                                                     dat Len, TW_CONST byte *Name) {
  return (tmenuitem)0;
}
...
/* ttobject */
static void twin_detunnel_Break_ttobject(ttobject o) {
  if (o) {
    if (o->native != TW_NOID) {
      Multiplex(order_DeleteObj, o->native);
      o->native = TW_NOID;
    }
...
/* ttvisible */
static void twin_detunnel_AtBuild_ttvisible(ttvisible o) {
  /*
  ...
  if (IS(ttwidget, o) && native != TW_NOID)
    while (child) {
      if ((child_native = child->native))
        Multiplex(order_MapWidget, child_native, native);
      child = child->next;
    }
}

/* ttnative */
static ttnative twin_detunnel_GetRoot_ttnative(void) {
  return Create_ttnative(Multiplex(order_FirstScreen));
}
static void twin_detunnel_Break_ttnative(ttnative o) {
  o->native = TW_NOID;
  TClass_default(ttnative)->Break(o);
}
static ttshort twin_detunnel_GetW_ttnative(ttnative o) {
  ttnative r = TClass_ttnative->GetRoot();
  if (r && r->native == o->native)
    return Multiplex(order_GetDisplayWidth);
  return TD(Stat)(o->native, TWS_widget_Width);
}
static ttshort twin_detunnel_GetH_ttnative(ttnative o) {
  ttnative r = TClass_ttnative->GetRoot();
  if (r && r->native == o->native)
    return Multiplex(order_GetDisplayHeight);
  return TD(Stat)(o->native, TWS_widget_Height);
}
...
static void twin_detunnel_ExposeCallback_ttwidget(tevent_any e, void *id) {
  ...
  if (o)
    Expose_ttvisible((ttvisible)o, e->EventWidget.X, e->EventWidget.Y, e->EventWidget.XWidth,
                     e->EventWidget.YWidth);
}
static void twin_detunnel_ResizeCallback_ttwidget(tevent_any e, void *id) {
  ttwidget o = ID2(ttwidget, (opaque)id);
  if (o) {
...
static ttcallback twin_detunnel_AddCommonCallbacks_ttwidget(ttwidget o) {
  ttcallback l[5];
  byte i = 0;
  void *id = (void *)OBJ2ID(o);

  if ((l[i] = Create_ttcallback((ttcomponent)o)) &&
      (l[i]->native = (opaque)TD(AddWidgetListener)(
           o->native, TW_MSG_WIDGET_EXPOSE, (tfn_listener)twin_detunnel_ExposeCallback_ttwidget,
           id)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native = (opaque)TD(AddWidgetListener)(
           o->native, TW_MSG_WIDGET_RESIZE, (tfn_listener)twin_detunnel_ResizeCallback_ttwidget,
           id))) {
...
static void twin_detunnel_AddTo_ttwidget(ttwidget o, ttvisible parent, ttany constraint) {
  if (parent && !o->parent) {
    TClass_default(ttwidget)->AddTo(o, parent, constraint);

    if (o->native != TW_NOID && parent->native != TW_NOID)
      Multiplex(order_MapWidget, o->native, parent->native);
  }
}
static void twin_detunnel_SetVisible_ttwidget(ttwidget o, ttbyte visible) {
  ...
  if (isvisible != wasvisibile && o->native != TW_NOID)
    Multiplex(order_SetVisibleWidget, o->native, visible);
}
static void twin_detunnel_Remove_ttwidget(ttwidget o) {
  if (o->parent) {
    TClass_default(ttwidget)->Remove(o);

    if (o->native != TW_NOID)
      Multiplex(order_UnMapWidget, o->native);
  }
}
static ttbyte twin_detunnel_SetXY_ttwidget(ttwidget o, ttshort x, ttshort y) {
  Multiplex(order_SetXYWidget, o->native, o->x = x, o->y = y);
  return TT_TRUE;
}
static ttbyte twin_detunnel_SetWH_ttwidget(ttwidget o, ttshort w, ttshort h) {
  Multiplex(order_ResizeWidget, o->native, o->w = w, o->h = h);
  return TT_TRUE;
}
static ttbyte twin_detunnel_SetXl_ttwidget(ttwidget o, ttint xl) {
  Multiplex(order_ScrollWidget, o->native, xl - o->xl, 0);
  o->xl = xl;
  return TT_TRUE;
}
static ttbyte twin_detunnel_SetYl_ttwidget(ttwidget o, ttint yl) {
  Multiplex(order_ScrollWidget, o->native, 0, yl - o->yl);
  o->yl = yl;
  return TT_TRUE;
}
static void twin_detunnel_Draw_ttwidget(ttwidget o, ttshort x, ttshort y, ttshort w, ttshort h,
                                        ttshort pitch, TT_CONST ttbyte *asciidata,
                                        TT_CONST ttfont *fontdata, TT_CONST ttattr *attrdata) {
  TD(Draw2Widget)(o->native, w, h, x, y, pitch, asciidata, fontdata, attrdata);
}
...
static void twin_detunnel_Invalidate_ttwidget(ttwidget o) {
  tttheme t;
...
/* ttanybutton */
static void twin_detunnel_Invalidate_ttanybutton(ttanybutton o) {
  /* needed because we have overridden Invalidate_ttwidget above */
  ttbyte i;

#ifdef DEBUG_TT_HW_TWIN
  fprintf(stderr, "twin_detunnel_Invalidate_ttanybutton(o=0x%X)\n", (unsigned)o->id);
#endif
...
static void twin_detunnel_BuiltinRepaint_ttanybutton(ttanybutton o, dat x, dat y, dat w, dat h) {
  ttattr *t;
  dat tw, th;
  ttuint i;
...
static void twin_detunnel_MouseCallback_ttanybutton(tevent_any e, tobj id) {
  ...
  if (o) {
    ...
    if ((code & HOLD_ANY)) {
      evcode |= (code & HOLD_LEFT ? ttevent_evcode_mouse_hold_1 : 0) |
    ...
    if (evcode >= ttevent_evcode_mouse_first && evcode <= ttevent_evcode_mouse_last &&
        (ev = (ttevent)Create4_tteventbig(ttevent_evtype_mouse, evcode, e->EventMouse.ShiftFlags,
...
static ttcallback twin_detunnel_AddCommonCallbacks_ttanybutton(ttanybutton o) {
  ttcallback l[5];
  byte i = 0;
  void *id = (void *)OBJ2ID(o);

  if ((l[i] = twin_detunnel_AddCommonCallbacks_ttwidget((ttwidget)o)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native = (opaque)TD(AddMouseListener)(
           o->native, MOVE_MOUSE, 0, (tfn_listener)twin_detunnel_MouseCallback_ttanybutton, id)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native = (opaque)TD(AddMouseListener)(
           o->native, PRESS_LEFT, 0, (tfn_listener)twin_detunnel_MouseCallback_ttanybutton, id)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native = (opaque)TD(AddMouseListener)(
           o->native, MOVE_MOUSE | HOLD_LEFT, 0,
           (tfn_listener)twin_detunnel_MouseCallback_ttanybutton, id)) &&
      (i++, (l[i] = Create_ttcallback((ttcomponent)o))) &&
      (l[i]->native = (opaque)TD(AddMouseListener)(
           o->native, RELEASE_LEFT, 0, (tfn_listener)twin_detunnel_MouseCallback_ttanybutton,
           id))) {
...
static ttanybutton twin_detunnel_Build_ttanybutton(ttanybutton o) {
  /* calculate o->w and o->h using theme: */
  o->Class->CacheThemeShape(o);

  if (TW_NOID != (o->native = Multiplex(order_CreateWidget, o->w, o->h,
                                        TW_WIDGET_WANT_MOUSE | TW_WIDGET_WANT_MOUSE_MOTION |
                                            TW_WIDGET_AUTO_FOCUS,
                                        TW_WIDGETFL_USEEXPOSE, 0, 0, o->col))) {
    if (twin_detunnel_AddCommonCallbacks_ttanybutton((ttanybutton)o)) {
      twin_detunnel_AtBuild_ttvisible((ttvisible)o);
      return o;
    }
  }
...
/* ttwindow */
static ttwindow twin_detunnel_Build_ttwindow(ttwindow o) {
  if (TW_NOID != (o->native = Multiplex(
                      order_CreateWindow, o->title ? TTLenStr(o->title) : 0, o->title, NULL,
                      TW_NOID, o->col, TW_LINECURSOR,
                      ...
                      TW_WINDOWFL_USEEXPOSE | TW_WINDOWFL_CURSOR_ON | TW_WINDOWFL_BORDERLESS, o->w,
                      o->h, 0))) {
    if (twin_detunnel_AddCommonCallbacks_ttwidget((ttwidget)o)) {
      twin_detunnel_AtBuild_ttvisible((ttvisible)o);
      return o;
...
/* ttframe */
static void twin_detunnel_AskCloseCallback_ttframe(tevent_any ev, tobj id) {
  ttframe o = ID2(ttframe, id);
  if (o)
    FireSimpleEvent((ttcomponent)o, ttevent_evtype_askclose);
}
static ttcallback twin_detunnel_AddAskCloseCallback_ttframe(ttframe o) {
  ttcallback l;
  opaque id = OBJ2ID(o);

  if ((l = Create_ttcallback((ttcomponent)o))) {
    if ((l->native = (opaque)TD(AddGadgetListener)(
             o->native, 0 /*CLOSE code*/, (tfn_listener)twin_detunnel_AskCloseCallback_ttframe,
             (void *)id)))
      return l;
    TDEL(l);
  }
...
static ttframe twin_detunnel_Build_ttframe(ttframe o) {
  /* ttframe are non-visible when created */
  o->vflags &= ~ttvisible_vflags_visible;

  if (TW_NOID != (o->native = Multiplex(
                      order_CreateWindow, o->title ? TTLenStr(o->title) : 0, o->title, NULL,
                      myMenubar_n(o), o->col, TW_LINECURSOR,
      ...
      twin_detunnel_AddCommonCallbacks_ttwidget((ttwidget)o) &&
      twin_detunnel_AddAskCloseCallback_ttframe(o)) {
 ...
 */
static void twin_detunnel_AddTo_ttframe(ttframe o, ttvisible parent, ttany constraint) {
  if (parent && !o->parent) {
    /* prepend to list */
...
static void twin_detunnel_SetVisible_ttframe(ttframe o, byte on_off) {
  on_off = !!on_off;
  if (on_off != !!(o->vflags & ttvisible_vflags_visible)) {
    o->vflags ^= ttvisible_vflags_visible;
    if (o->parent) {
      if (on_off)
        Multiplex(order_MapWidget, o->native, o->parent->native);
      else
        Multiplex(order_UnMapWidget, o->native);
    }
  }
}
static ttbyte twin_detunnel_SetTitle_ttframe(ttframe o, TT_ARG_READ ttbyte *title) {
  if (TClass_default(ttframe)->SetTitle(o, title)) {

    Multiplex(order_SetTitleWindow, o->native, o->title_len, o->title);
...
/* ttmenuitem */
static void twin_detunnel_AddTo_ttmenuitem(ttmenuitem o, ttvisible parent, ttany constraint) {
  /* append */
  tobj Code;
  ...
  if (parent && !o->parent && TTAssert(IS(ttmenu, parent)) &&
    ...
    if (!(udat)Code)
      Code = 1 + (rand() & 0xFFF);
    o->native = TD(Create4MenuRow)(
        parent->target_private, Code,
        *o->name ? (o->vflags & ttanybutton_vflags_disabled) ? TW_ROW_ACTIVE : TW_ROW_INACTIVE
                 : TW_ROW_IGNORE,
...
static void twin_detunnel_Remove_ttmenuitem(ttmenuitem o) {
  if (o->parent) {
...
static void twin_detunnel_AddTo_ttmenu(ttmenu o, ttvisible parent, ttany constraint) {
  if (!o->parent && parent && TTAssert(IS(ttmenu, parent) || IS(ttmenubar, parent)) &&
    ...
    if (TW_NOID != (o->target_private = Multiplex(order_Create4MenuWindow, myMenubar_n(o))) &&
        TW_NOID != (o->native = TD(Create4MenuMenuItem)(parent->native, o->target_private,
...
static void twin_detunnel_Remove_ttmenu(ttmenu o) {
  if (o->parent) {
    TClass_default(ttmenu)->Remove(o);

    if (o->target_private != TW_NOID) {
      Multiplex(order_DeleteObj, o->target_private);
...
static ttmenubar twin_detunnel_Build_ttmenubar(ttmenubar o) {
  tttheme t = myTheme(o);
  if (TW_NOID !=
      (o->native =
           Multiplex(order_CreateMenu, t->bg[tttheme_bg_menu_normal], t->bg[tttheme_bg_menu_select],
    ...
    Multiplex(order_Create4MenuCommonMenuItem, o->native);
    twin_detunnel_AtBuild_ttvisible((ttvisible)o);
...
static ttapplication twin_detunnel_Build_ttapplication(ttapplication o) {
  if (o->name && TW_NOID != (o->native = Multiplex(order_CreateMsgPort, strlen(o->name), o->name)))
    return o;
  return NULL;
}
...
static void twin_detunnel_DeleteCallback(ttcallback o) {
...
/*
 * use default values for methods not implemented in twin_detunnel_c
 *
...
static s_ttclasses twin_detunnel_TTClasses = {
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_ttevent */, (void *)NULL /* UNDEFINED: Build_ttevent */,
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_ttbitmask */, (void *)NULL /* UNDEFINED: Build_ttbitmask */,
...

    {
        ...
        twin_detunnel_GetRoot_ttnative,
        twin_detunnel_GetW_ttnative,
        twin_detunnel_GetH_ttnative,
...

    {
        ...
        /* extends ttclass_ttcomponent */
        twin_detunnel_AddTo_ttwidget,
        (void *)NULL /* UNDEFINED: Validate_ttwidget */,
        twin_detunnel_Remove_ttwidget,
        twin_detunnel_Invalidate_ttwidget,
        twin_detunnel_SetVisible_ttwidget,
        (void *)NULL /* UNDEFINED: SetTheme_ttwidget */,
        twin_detunnel_Draw_ttwidget,
        twin_detunnel_BuiltinRepaint_ttwidget,

        /* extends ttclass_ttvisible */
        (void *)NULL /* UNDEFINED: SetLayout_ttwidget */,
        twin_detunnel_SetXY_ttwidget,
        twin_detunnel_SetWH_ttwidget,
        twin_detunnel_SetXl_ttwidget,
        twin_detunnel_SetYl_ttwidget,
...

    {
        ...
        twin_detunnel_BuiltinRepaint_ttlabel,
...

    {
        ...
        twin_detunnel_Build_ttanybutton,
        ...
        twin_detunnel_Invalidate_ttanybutton,
        ...
        twin_detunnel_BuiltinRepaint_ttanybutton,
...

    {
        ...
        /* extends ttclass_ttwidget */
        twin_detunnel_SetTitle_ttframe,
...

    {
        ...
        /* extends ttclass_ttcomponent */
        twin_detunnel_AddTo_ttmenuitem, (void *)NULL /* UNDEFINED: Validate_ttmenuitem */,
        twin_detunnel_Remove_ttmenuitem, (void *)NULL /* UNDEFINED: Invalidate_ttmenuitem */,
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_ttmenu */, (void *)NULL /* UNDEFINED: Build_ttmenu */,
        ...
        /* extends ttclass_ttcomponent */
        twin_detunnel_AddTo_ttmenu, (void *)NULL /* UNDEFINED: Validate_ttmenu */,
        twin_detunnel_Remove_ttmenu, (void *)NULL /* UNDEFINED: Invalidate_ttmenu */,
        (void *)NULL /* UNDEFINED: SetVisible_ttmenu */,
        (void *)NULL /* UNDEFINED: SetTheme_ttmenu */, (void *)NULL /* UNDEFINED: Draw_ttmenu */,
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_ttmenubar */, twin_detunnel_Build_ttmenubar,
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_tttheme */, (void *)NULL /* UNDEFINED: Build_tttheme */,
...

    {
        ...
        /* extends ttclass_ttobj */
        (void *)NULL /* UNDEFINED: New_ttapplication */, twin_detunnel_Build_ttapplication,
...

    {
        ...
        twin_detunnel_Sync,
        twin_detunnel_Flush,
        twin_detunnel_TimidFlush,
        twin_detunnel_MainLoopOnce,
        twin_detunnel_DeleteCallback,
        twin_detunnel_Close,
        twin_detunnel_ConnectionFd,
        twin_detunnel_GetErrno,
        twin_detunnel_GetErrnoDetail,
        twin_detunnel_StrError,
        twin_detunnel_StrErrorDetail,
    },
};
