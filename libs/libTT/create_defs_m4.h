...
#define CreateMouse_ttlistener                TTD.CREATE.CreateMouse_ttlistener
...
#define Create_ttcheckbutton                TTD.CREATE.Create_ttcheckbutton 
#define Create_ttradiobutton                TTD.CREATE.Create_ttradiobutton                              
#define Create1_ttscrollbar                TTD.CREATE.Create1_ttscrollbar
#define Create4_ttscrollbar                TTD.CREATE.Create4_ttscrollbar             
#define Create_ttslider                TTD.CREATE.Create_ttslider 
#define Create_ttprogressbar                TTD.CREATE.Create_ttprogressbar 
