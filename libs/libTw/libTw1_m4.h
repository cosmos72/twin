...
{ Tw_RaiseWidget, 11, 4, "Tw_RaiseWidget", "2""v"TWS_void_STR"x"magic_id_STR(widget) },
{ Tw_LowerWidget, 11, 4, "Tw_LowerWidget", "2""v"TWS_void_STR"x"magic_id_STR(widget) },
{ Tw_RestackChildrenWidget, 21, 8, "Tw_RestackChildrenWidget", "0""v"TWS_void_STR"x"magic_id_STR(widget)"_"TWS_uldat_STR"X"magic_id_STR(widget) },
{ Tw_CirculateChildrenWidget, 23, 6, "Tw_CirculateChildrenWidget", "0""v"TWS_void_STR"x"magic_id_STR(widget)"_"TWS_byte_STR },


{ Tw_CreateGadget, 12, 28, "Tw_CreateGadget", "0""x"magic_id_STR(gadget)"x"magic_id_STR(widget)"_"TWS_dat_STR"_"TWS_dat_STR"W"TWS_byte_STR"_"TWS_uldat_STR"_"TWS_uldat_STR"_"TWS_udat_STR"_"TWS_hwcol_STR"_"TWS_hwcol_STR"_"TWS_hwcol_STR"_"TWS_hwcol_STR"_"TWS_dat_STR"_"TWS_dat_STR },

{ Tw_CreateButtonGadget, 18, 24, "Tw_CreateButtonGadget", "1""x"magic_id_STR(gadget)"x"magic_id_STR(widget)"_"TWS_dat_STR"_"TWS_dat_STR"V"TWS_byte_STR"_"TWS_uldat_STR"_"TWS_udat_STR"_"TWS_hwcol_STR"_"TWS_hwcol_STR"_"TWS_hwcol_STR"_"TWS_dat_STR"_"TWS_dat_STR },
...
{ Tw_WriteStringWindow, 17, 8, "Tw_WriteStringWindow", "0""v"TWS_void_STR"x"magic_id_STR(window)"_"TWS_ldat_STR"V"TWS_byte_STR },
{ Tw_WriteHWFontWindow, 17, 8, "Tw_WriteHWFontWindow", "0""v"TWS_void_STR"x"magic_id_STR(window)"_"TWS_ldat_STR"V"TWS_hwfont_STR },
...
{ Tw_FindRowByCodeWindow, 19, 6, "Tw_FindRowByCodeWindow", "0""x"magic_id_STR(row)"x"magic_id_STR(window)"_"TWS_dat_STR },

{ Tw_CreateGroup, 11, 2, "Tw_CreateGroup", "0""x"magic_id_STR(group) },
{ Tw_InsertGadgetGroup, 17, 6, "Tw_InsertGadgetGroup", "2""v"TWS_void_STR"x"magic_id_STR(group)"x"magic_id_STR(gadget) },
...
{ Tw_FirstMsgPort, 12, 2, "Tw_FirstMsgPort", "0""x"magic_id_STR(msgport) },
{ Tw_FirstMenu, 9, 4, "Tw_FirstMenu", "0""x"magic_id_STR(menu)"x"magic_id_STR(msgport) },
{ Tw_FirstW, 6, 4, "Tw_FirstW", "0""x"magic_id_STR(widget)"x"magic_id_STR(msgport) },
{ Tw_FirstGroup, 10, 4, "Tw_FirstGroup", "0""x"magic_id_STR(group)"x"magic_id_STR(msgport) },
{ Tw_FirstMutex, 10, 4, "Tw_FirstMutex", "0""x"magic_id_STR(mutex)"x"magic_id_STR(msgport) },
{ Tw_FirstMenuItem, 13, 4, "Tw_FirstMenuItem", "0""x"magic_id_STR(menuitem)"x"magic_id_STR(menu) },
{ Tw_FirstGadget, 11, 4, "Tw_FirstGadget", "0""x"magic_id_STR(gadget)"x"magic_id_STR(group) },

{ Tw_GetDisplayWidth, 15, 2, "Tw_GetDisplayWidth", "0""_"TWS_dat_STR },
{ Tw_GetDisplayHeight, 16, 2, "Tw_GetDisplayHeight", "0""_"TWS_dat_STR },
{ Tw_GetAll, 6, 2, "Tw_GetAll", "0""x"magic_id_STR(all) },

{ Tw_SendToMsgPort, 13, 8, "Tw_SendToMsgPort", "0""_"TWS_byte_STR"x"magic_id_STR(msgport)"_"TWS_udat_STR"V"TWS_byte_STR },
