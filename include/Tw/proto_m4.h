...
void Tw_DrawWidget(tdisplay TwD, twidget W, dat w, dat h, dat x, dat y, const char *text,
                   const trune *textfont, const tcell *textattr);
...
tgadget Tw_CreateGadget(tdisplay TwD, twidget parent, dat w, dat h, const char *text, uldat attrib,
                        uldat flags, udat code, tcolor coltext, tcolor colselect,
                        tcolor coldisabled, tcolor colselectdisabled, dat x, dat y);

tgadget Tw_CreateButtonGadget(tdisplay TwD, twidget parent, dat w, dat h, const char *text,
                              uldat flags, udat code, tcolor colbg, tcolor col, tcolor coldisabled,
                              dat x, dat y);

void Tw_WriteTextsGadget(tdisplay TwD, tgadget G, byte mask, dat w, dat h, const char *text, dat x,
                         dat y);
...
tmenu Tw_CreateMenu(tdisplay TwD, tcolor colitem, tcolor colselect, tcolor coldisabled,
                    ...
                    byte flags);
void Tw_SetInfoMenu(tdisplay TwD, tmenu M, byte flags, ldat len, const char *text,
