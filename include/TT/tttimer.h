...
tttimer TTCreateR_tttimer(ttcomponent r, ttuint lflags, TT_ARG_READ ttlistener_fn function,
                          ttopaque arg_component_n, ttopaque arg_timer_n, TT_ARG_DIE ttvector args,
                          ttany delay_t, ttany delay_f);

/** create a tttimer with given fields */
tttimer TTCreate_tttimer(ttcomponent r, ttuint lflags, TT_ARG_READ ttlistener_fn function,
                         ttany arg, ttany delay_t, ttany delay_f);
