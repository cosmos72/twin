...
#define TT_PROTOCOL_VERSION                                                                        \
  ((TT_PROTOCOL_VERSION_MAJOR << 16) | (TT_PROTOCOL_VERSION_MINOR << 8) | TT_PROTOCOL_VERSION_PATCH)
/** string reperesenting library full version number ("major.minor.patch") */
#define TT_PROTOCOL_VERSION_STR                                                                    \
  TT_STR(TT_PROTOCOL_VERSION_MAJOR)                                                                \
  "." TT_STR(TT_PROTOCOL_VERSION_MINOR) "." TT_STR(TT_PROTOCOL_VERSION_PATCH)
