...
8, "Tw_WriteCharsetWindow", "0" "v" TWS_void_STR"x" magic_id_STR(window)"_" TWS_uldat_STR"V" TWS_char_STR },
{ Tw_WriteUtf8Window, 15,
8, "Tw_WriteUtf8Window", "0" "v" TWS_void_STR"x" magic_id_STR(window)"_" TWS_uldat_STR"V" TWS_char_STR },
