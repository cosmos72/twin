...
#define ttevent_mouse_is_move(code)                                                                \
  (((code)&ttevent_evcode_mouse_action_mask) == ttevent_evcode_mouse_move)
#define ttevent_mouse_is_press(code)                                                               \
  (((code)&ttevent_evcode_mouse_action_mask) == ttevent_evcode_mouse_press)
#define ttevent_mouse_is_release(code)                                                             \
  (((code)&ttevent_evcode_mouse_action_mask) == ttevent_evcode_mouse_release)
...
#define ttevent_evcode_mouse_release_1                                                             \
  (ttevent_evcode_mouse_release | ttevent_evcode_mouse_button_1)
#define ttevent_evcode_mouse_release_2                                                             \
  (ttevent_evcode_mouse_release | ttevent_evcode_mouse_button_2)
#define ttevent_evcode_mouse_release_3                                                             \
  (ttevent_evcode_mouse_release | ttevent_evcode_mouse_button_3)
#define ttevent_evcode_mouse_release_4                                                             \
  (ttevent_evcode_mouse_release | ttevent_evcode_mouse_button_4)
...
/** ttlistener flag indicating the function will receive the component generating the event as first
 * arg */
...
/** ttwidget flag indicating the style used to hold its contents (fill repeating with a single
 * ttattr) */
...
/** ttwidget flag indicating the style used to hold its contents (use expose events and cache
 * result) */
#define ttwidget_vflags_style_cache 8
/** ttwidget flag indicating the style used to hold its contents (store in a bi-dimensional array of
 * ttattr:s) */
#define ttwidget_vflags_style_contents 0x10
/** ttwidget flag indicating the style used to hold its contents (store each row in a
 * one-dimensional array of ttattr:s) */
